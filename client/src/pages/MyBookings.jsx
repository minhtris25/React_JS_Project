...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:mt-32 px-4 md:px-16 lg-px-24 xl:px-32'>
        ...
        and upcoming hotel reservations in one place. Plan your trips seamlessly with just a few clicks"
        align="left"/>
        
        <div className='max-w-6xl mt-8 w-full text-gray-800'>

            <div className='hidden md:grid md:grid-cols-[3fr,2fr,1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
